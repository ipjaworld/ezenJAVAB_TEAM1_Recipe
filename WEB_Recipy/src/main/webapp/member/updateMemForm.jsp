        ...
        <%-- <input type="hidden" name="code" value="${loginUser.code}"> --%>
         <input type="hidden" name="oldImg" value="${loginUser.img}">
            ...
            <fieldset>
                ...
                <label>전화번호</label><input  type="text" name="phone"  value="${loginUser.phone}"><br>
                ...
                <label>주    소</label><input type="text" name="address1"  size="50" value="${loginUser.address1}"><br>
                <label>상세주소</label><input type="text" name="address2"  size="25" value="${loginUser.address2}"><br>
                <label>이메일</label><input type="text" name="email" value="${loginUser.email}"><br>
